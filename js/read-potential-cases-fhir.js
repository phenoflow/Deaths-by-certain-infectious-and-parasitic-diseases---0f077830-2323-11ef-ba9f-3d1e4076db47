...
(async () => {
  ...
  await fs.writeFile("deaths-by-certain-infectious-and-parasitic-diseases-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("deaths-by-certain-infectious-and-parasitic-diseases-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
